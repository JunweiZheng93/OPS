_base_ = [
    '../_base_/models/ops_vit-b16.py', '../_base_/datasets/coco-stuff164k.py',
...
# By default, models are trained on 4 GPU with 8 images per GPU
train_dataloader = dict(batch_size=8,
                        dataset=dict(data_prefix=dict(img_path='images/train2017_erp_shuffle',
                                                      seg_map_path='annotations/train2017_erp_shuffle'),
                                     pipeline=train_pipeline))
val_dataloader = dict(batch_size=1,
                      dataset=dict(data_prefix=dict(img_path='images/val2017_erp_no_shuffle',
                                                    seg_map_path='annotations/val2017_erp_no_shuffle'),
